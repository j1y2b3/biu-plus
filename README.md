...
> **改版说明（Fork）**
>
> 本仓库是 [wood3n/biu](https://github.com/wood3n/biu) 的**个人改版（fork）**，在原版基础上做了自定义修改，**不是官方版本**，与哔哩哔哩（B 站）无任何官方关联或背书，仅供个人使用。
>
> 相对原版的主要改动：
> - **多P视频默认只播放第一个分P**，其余分P可在分集列表中按需添加
> - **歌词偏移**改为上下箭头调节，偏移时间无限制、长按连发 + 一键重置
> - **播放中断/卡住自动恢复**（自动刷新链接重试并续播），切歌获取链接失败自动重试
> - 主页改为**动态**，移除推荐音乐入口
